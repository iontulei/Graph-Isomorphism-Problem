...
class Vertex(object):
    ...
    def __init__(self, graph: "Graph", label=None, colornum: "int" = None):
        """
    ...
    def __repr__(self):
        ...
        """
        return 'Vertex(label={}, colornum={}, #incident={})'.format(self.label, self.colornum, len(self._incidence))
...
class Graph(object):
    ...
    @property
    def colornums(self) -> list[int]:
        """
        Returns a list of the colornums of all vertices in the graph.
        """
        return [vertex.colornum for vertex in self._v]

    @property
    def distinct_colornums(self) -> list[int]:
        """
        Returns a list of the distinct colornums of the vertices in the graph.
        """
        return list(set(self.colornums))
